  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <main style={{ flex: 1, padding: 20 }}>
        <div style={{ fontSize: 18, fontWeight: 600, marginBottom: 16 }}>Pipeline</div>
        <div className="card" style={{ padding: 40, textAlign: 'center' }}>
          <div style={{ fontSize: 14, color: '#4A5568', marginBottom: 8 }}>Recruiting pipeline kanban board</div>
          <div style={{ fontSize: 12, color: '#4A5568' }}>Drag-and-drop stages connecting from RKRT</div>
        </div>
      </main>
    </div>
  )
